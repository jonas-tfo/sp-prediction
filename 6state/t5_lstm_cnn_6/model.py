...
from .utils import inverse_freq_weights
...
class SPCNNClassifier(nn.Module):
    def __init__(
        ...
        class_weights: torch.Tensor = inverse_freq_weights(Config.LABEL_DIST, Config.LABEL_MAP),
    ...
    def forward(
        ...
        if labels is not None:
            ...
            # Weighted cross-entropy loss Reshape for CE: (batch * seq_len, num_labels) and (batch * seq_len)
