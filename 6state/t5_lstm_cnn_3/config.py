...
class Config:
    ...
    TRAIN_VAL_LOSSES_PKL_SAVE_PATH = PLOTS_SAVE_DIR / "6state_t5_lstm_cnn_3_fold_results.pkl"

    # Model Saving Paths
    MODEL_DIR = OUTPUT_DIR / "models"
    MODEL_SAVE_PATH = MODEL_DIR / "6state_t5_lstm_cnn_3.pt"
    MODEL_SAVE_PATH_TEMP = str(MODEL_DIR / "6state_t5_lstm_cnn_3_fold{}.pt")
